...
| Doc | What it's for |
| --- | --- |
| [LOCAL_DEV.md](./LOCAL_DEV.md) | Running the server locally, and the known Turbopack-cache crash + fix |
| [DEPLOYMENT.md](./DEPLOYMENT.md) | The full step-by-step guide to going live (Vercel + Postgres), env vars, security/legal checklist |
...
Start at the main [README](../README.md) for project overview and first-time setup.
