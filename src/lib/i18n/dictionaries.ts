...
const it: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Confermato — paga il corriere alla consegna.",
    errStart: "Non è stato possibile avviare il pagamento. Riprova.",
    errBank: "Non è stato possibile avviare il bonifico. Riprova.",
    errCod: "Non è stato possibile confermare il pagamento alla consegna. Riprova.",
  },
  a11y: {
...
const fr: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Confirmé — payez le livreur à la réception.",
    ...
    errCod: "Impossible de confirmer le paiement à la livraison. Veuillez réessayer.",
  },
  a11y: {
...
const de: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Bestätigt – bezahlen Sie bei der Lieferung beim Zusteller.",
    ...
    errCod: "Die Zahlung bei Lieferung konnte nicht bestätigt werden. Bitte versuchen Sie es erneut.",
  },
  a11y: {
...
const ar: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "تم التأكيد — ادفع للمندوب عند الاستلام.",
    errStart: "تعذّر بدء الدفع. يرجى المحاولة مرة أخرى.",
    errBank: "تعذّر بدء التحويل المصرفي. يرجى المحاولة مرة أخرى.",
    errCod: "تعذّر تأكيد الدفع عند الاستلام. يرجى المحاولة مرة أخرى.",
  },
  a11y: {
...
const ru: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Подтверждено — оплатите курьеру при получении.",
    errStart: "Не удалось начать оплату. Повторите попытку.",
    errBank: "Не удалось начать банковский перевод. Повторите попытку.",
    errCod: "Не удалось подтвердить оплату при получении. Повторите попытку.",
  },
  a11y: {
...
const es: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Confirmado — paga al repartidor en la entrega.",
    ...
    errCod: "No se pudo confirmar el pago contra reembolso. Inténtalo de nuevo.",
  },
  a11y: {
...
const pt: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "Confirmado — pague ao estafeta na entrega.",
    ...
    errCod: "Não foi possível confirmar o pagamento na entrega. Tente novamente.",
  },
  a11y: {
...
const hi: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "पुष्टि हो गई — डिलीवरी पर कूरियर को भुगतान करें।",
    ...
    errCod: "कैश ऑन डिलीवरी की पुष्टि नहीं हो सकी। कृपया फिर कोशिश करें।",
  },
  a11y: {
...
const ja: Dictionary = {
  ...
  payment: {
    ...
    codConfirmed: "確認しました。お届け時に配達員へお支払いください。",
    errStart: "お支払いを開始できませんでした。もう一度お試しください。",
    errBank: "銀行振込を開始できませんでした。もう一度お試しください。",
    errCod: "代金引換を確認できませんでした。もう一度お試しください。",
  },
  a11y: {
