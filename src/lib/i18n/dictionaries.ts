...
const it: Dictionary = {
  ...
  faq: {
    ...
    giftA: "Assolutamente sì: ogni pezzo arriva pronto da regalare. Se non sai quale scegliere, il nostro Gift Finder ti suggerisce dei pezzi in poche domande.",
...
const fr: Dictionary = {
  ...
  faq: {
    ...
    giftLink: "Essayer le Gift Finder",
    ...
    giftA: "Tout à fait : chaque pièce arrive prête à offrir. Si vous hésitez, notre Gift Finder vous suggère des pièces en quelques questions.",
...
const de: Dictionary = {
  ...
  faq: {
    ...
    giftA: "Sehr gut: Jedes Stück kommt bereit zum Verschenken an. Wenn Sie unsicher sind, schlägt Ihnen unser Gift Finder in wenigen Fragen passende Stücke vor.",
...
const es: Dictionary = {
  ...
  faq: {
    ...
    giftLink: "Probar el Gift Finder",
    ...
    giftA: "Sin duda: cada pieza llega lista para regalar. Si no sabes cuál elegir, nuestro Gift Finder te sugiere piezas con unas pocas preguntas.",
...
const pt: Dictionary = {
  ...
  faq: {
    ...
    giftLink: "Experimentar o Gift Finder",
    ...
    giftA: "Sem dúvida: cada peça chega pronta a oferecer. Se não souber qual escolher, o nosso Gift Finder sugere peças com algumas perguntas rápidas.",
