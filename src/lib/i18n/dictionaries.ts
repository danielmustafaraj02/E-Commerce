...
const fr: Dictionary = {
  ...
  cart: {
    ...
    shippingNote: "Les frais de livraison sont calculés lors de la commande.",
...
const de: Dictionary = {
  ...
  cart: {
    ...
    shippingNote: "Der Versand wird an der Kasse berechnet.",
...
const ru: Dictionary = {
  ...
  cart: {
    ...
    shippingNote: "Стоимость доставки рассчитывается при оформлении заказа.",
...
const es: Dictionary = {
  ...
  cart: {
    ...
    shippingNote: "El envío se calcula al pagar.",
    checkout: "Ir a pagar",
    remove: "Quitar",
...
const pt: Dictionary = {
  ...
  cart: {
    ...
    browse: "Explorar produtos",
    estimatedSubtotal: "Subtotal estimado",
    shippingNote: "O envio é calculado ao finalizar a compra.",
...
const hi: Dictionary = {
  ...
  cart: {
    ...
    shippingNote: "शिपिंग की गणना चेकआउट पर की जाती है।",
