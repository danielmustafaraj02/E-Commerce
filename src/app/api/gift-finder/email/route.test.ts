...
function post(body: unknown) {
  return POST(new Request("http://localhost/api/gift-finder/email", { method: "POST", body: JSON.stringify(body) }));
}
...
beforeEach(() => {
  ...
  mocks.findMany.mockReset().mockResolvedValue([
    { id: "p1", slug: "collana-fiore", name: "Collana Fiore", nameEn: "Flower Necklace", price: 8900, currency: "EUR" },
  ]);
});
