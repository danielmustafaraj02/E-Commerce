...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    `> ${summary}`,
    "",
    "The storefront is available in English, Italian, French, German, Arabic, Chinese, Russian, Spanish, Portuguese, Hindi and Japanese; language follows the visitor's browser settings. " +
